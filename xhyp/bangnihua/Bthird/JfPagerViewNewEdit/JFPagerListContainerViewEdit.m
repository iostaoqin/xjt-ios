//
//  JFPagerListContainerViewEdit.m
//  JFPagerViewEdit
//
...
@interface JFPagerListContainerViewEdit() <UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>
@property (nonatomic, strong) JXPagerListContainerCollectionView *collectionView;
@end

@implementation JFPagerListContainerViewEdit

- (instancetype)initWithDelegate:(id<JFPagerListContainerViewEditDelegate>)delegate {
